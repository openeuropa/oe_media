  ...
  protected function providerTestFormat(): array {
    return [
      ...
      'EbS Live embed code' => [
        ...
        'expected' => '<iframe src="http://web:8080/tests/fixtures/example.html" width="852" height="480" frameborder="0" scrolling="no" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen="true"></iframe>',
      ],
      'iframe with all existing iframe attributes' => [
        ...
        'expected' => '<iframe src="http://web:8080/tests/fixtures/example.html" width="800" height="600" frameborder="0" allowfullscreen="" importance="" loading="" referrerpolicy="" sandbox="" mozallowfullscreen="" webkitallowfullscreen="" scrolling="" lang="" xml:lang="" xml:lang=""></iframe>',
      ],
